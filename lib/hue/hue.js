...
var hue = function ($, colors) { 
    ...
    var shortFlashType = 'select',
         ...
         */
        putGroupAction = function(groupIndex /* {Number} */, action /* String */ , callback) {
    ...
    return {
         ...
         * @return {Object} JSON object containing lamp state.
         */
        setColor: function(lampIndex /* Number */, color /* String */, callback) {
            var state = buildXYState(colors.getCIEColor(color));
            return put(lampIndex, state, callback);
        },
        /**
         ...
         * @return {Object} JSON object containing lamp state.
         */
        setAllColors: function(color /* String */, callback) {
            var state = buildXYState(colors.getCIEColor(color));
            return putGroupAction(0, state, callback);
        },
        /**
